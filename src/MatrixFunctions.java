...
public class MatrixFunctions {
    ...
    public static RecursiveTask<double[][]> firstThread(CountDownLatch latch, CyclicBarrier barrier) {
        return new RecursiveTask() {
            ...
            protected double[][] compute() {
                ...
                writeTimeToFile("Lab5_Time", text_1);
    ...
    public static RecursiveTask<double[][]> secondThread(CountDownLatch latch, CyclicBarrier barrier) {
        return new RecursiveTask() {
            @Override
            protected double[][] compute() {
                ...
                double[][] right = Lab.result;
                double[][] MA = Calculation.subtract(left, right);

                Lab.lock.lock();
                try {
                    writeToFile("Lab5_MA", MA);
                ...
                writeTimeToFile("Lab5_Time", text_2);
